...
public class Simulation {
   ...
   public static void main(String[] args) throws Exception {
      ...
      int numNodes = 100;
      double p_graph = Double.parseDouble("0.1"); // parameter for random graph: prob. that an edge will exist
      double p_malicious = Double.parseDouble("0.15"); // prob. that a node will be set to be malicious
      double p_txDistribution = Double.parseDouble("0.01"); // probability of assigning an initial transaction to each node 
      int numRounds = Integer.parseInt("10"); // number of simulation rounds your nodes will run for
      ...
      //compute the hash of all files and find the equal ones
